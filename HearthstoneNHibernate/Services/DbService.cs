using HearthstoneNHibernate.Mapping;
using NHibernate;
...
namespace HearthstoneNHibernate.Services
{
    public class DbService
    {
        public static Configuration Configure()
        {
            Configuration cfg = new Configuration()
                           ...
                           {
                               db.ConnectionString = @"Server = (localdb)\mssqllocaldb; Database = TestDb; Trusted_Connection = True;";
